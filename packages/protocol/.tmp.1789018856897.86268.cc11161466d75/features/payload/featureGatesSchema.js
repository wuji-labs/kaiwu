import { z } from 'zod';
import { FeatureGateSchema } from './featureGate.js';
const DEFAULT_GATE_DISABLED = { enabled: false };
const DEFAULT_GATE_ENABLED = { enabled: true };
...
//# sourceMappingURL=featureGatesSchema.js.map