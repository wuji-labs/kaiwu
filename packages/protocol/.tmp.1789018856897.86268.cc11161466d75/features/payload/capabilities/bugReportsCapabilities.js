...
export const DEFAULT_BUG_REPORTS_CAPABILITIES = {
    providerUrl: null,
...
export function coerceBugReportsCapabilitiesFromFeaturesPayload(payload) {
    ...
    const acceptedArtifactKinds = Array.isArray(bugReports.acceptedArtifactKinds)
        ? Array.from(new Set(bugReports.acceptedArtifactKinds
    ...
    const candidate = {
        ...
        acceptedArtifactKinds: acceptedArtifactKinds.length > 0 ? acceptedArtifactKinds : DEFAULT_BUG_REPORTS_CAPABILITIES.acceptedArtifactKinds,
...
//# sourceMappingURL=bugReportsCapabilities.js.map