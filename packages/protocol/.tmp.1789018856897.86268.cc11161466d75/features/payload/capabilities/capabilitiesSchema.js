...
import { BugReportsCapabilitiesSchema, DEFAULT_BUG_REPORTS_CAPABILITIES, } from './bugReportsCapabilities.js';
import { DEFAULT_VOICE_CAPABILITIES, VoiceCapabilitiesSchema } from './voiceCapabilities.js';
import { DEFAULT_SOCIAL_FRIENDS_CAPABILITIES, SocialFriendsCapabilitiesSchema, } from './socialFriendsCapabilities.js';
import { AuthCapabilitiesSchema, DEFAULT_AUTH_CAPABILITIES, } from './authCapabilities.js';
import { DEFAULT_ENCRYPTION_CAPABILITIES, EncryptionCapabilitiesSchema, } from './encryptionCapabilities.js';
import { DEFAULT_MACHINE_TRANSFER_CAPABILITIES, MachineTransferCapabilitiesSchema, } from './machineTransferCapabilities.js';
import { DEFAULT_SERVER_CAPABILITIES, ServerCapabilitiesSchema, } from './serverCapabilities.js';
import { DEFAULT_SERVER_IDENTITY_CAPABILITIES, ServerIdentityCapabilitiesSchema, } from './serverIdentityCapabilities.js';
import { DEFAULT_PETS_CAPABILITIES, PetsCapabilitiesSchema, } from './petsCapabilities.js';
import { DEFAULT_SESSION_CAPABILITIES, SessionCapabilitiesSchema, } from './sessionCapabilities.js';
import { DEFAULT_SHARING_CAPABILITIES, SharingCapabilitiesSchema, } from './sharingCapabilities.js';
import { ConnectedServicesCapabilitiesSchema, DEFAULT_CONNECTED_SERVICES_CAPABILITIES, } from './connectedServicesCapabilities.js';
...
//# sourceMappingURL=capabilitiesSchema.js.map