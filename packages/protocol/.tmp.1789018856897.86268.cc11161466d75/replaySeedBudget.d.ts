 ...
 */
export declare const HAPPIER_REPLAY_SEED_MIN_CHARS = 1024;
/** Upper bound on a seed budget, shared by every owner that states one. */
export declare const HAPPIER_REPLAY_SEED_MAX_CHARS = 200000;
/**
 ...
 */
export declare const HAPPIER_REPLAY_SEED_ACCEPTED_MIN_CHARS = 200;
/** Bounds on the legacy `recentMessagesCount` window. */
export declare const HAPPIER_REPLAY_RECENT_MESSAGES_MIN_COUNT = 1;
export declare const HAPPIER_REPLAY_RECENT_MESSAGES_MAX_COUNT = 500;
/** The budget an owner may WRITE: settings catalog, settings screen, env clamp. */
export declare const HappierReplayWritableMaxSeedCharsSchema: any;
/** The budget a wire READER accepts, including from released older clients. */
export declare const HappierReplayWireMaxSeedCharsSchema: any;
/** The `recentMessagesCount` window, identical for writers and the wire. */
export declare const HappierReplayRecentMessagesCountSchema: any;
//# sourceMappingURL=replaySeedBudget.d.ts.map