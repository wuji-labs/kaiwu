 ...
 */
export function encodeAgentActivityIdComponent(value, label) {
...
export function buildAgentActivityEntryId(ref) {
 ...
 */
export function parseAgentActivityEntryId(entryId) {
    ...
    if (prefix === ENTRY_ID_PREFIX_BY_KIND.workflow_agent && parts.length === 3) {
        ...
        if (runId.length === 0 || agentId.length === 0)
            return null;
 ...
 */
export function resolveAgentActivityEntryAgentHandle(entryId) {
...
//# sourceMappingURL=agentActivityEntryId.js.map