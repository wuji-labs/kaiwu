...
export declare const WORKFLOW_AGENT_SIDECHAIN_ID_PREFIX = "workflow_agent_sidechain";
export declare function buildWorkflowAgentSidechainId(params: Readonly<{
    workflowToolUseId: string;
    agentId: string;
}>): string;
//# sourceMappingURL=workflowAgentSidechainId.d.ts.map