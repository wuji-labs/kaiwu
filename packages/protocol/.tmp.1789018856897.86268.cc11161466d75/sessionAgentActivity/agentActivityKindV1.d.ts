 ...
 */
export declare const AGENT_ACTIVITY_KINDS_V1: readonly ["workflow_run", "workflow_agent"];
export declare const AgentActivityKindV1Schema: any;
export type AgentActivityKindV1 = z.infer<typeof AgentActivityKindV1Schema>;
//# sourceMappingURL=agentActivityKindV1.d.ts.map