...
function resolveTailscaleApprovalPollConfigFromEnv(): Readonly<{
  ...
  return {
    timeoutMs: parseNonNegativeIntEnv('KAIWU_TAILSCALE_APPROVAL_POLL_TIMEOUT_MS', DEFAULT_TAILSCALE_APPROVAL_POLL_TIMEOUT_MS),
    intervalMs: parseNonNegativeIntEnv('KAIWU_TAILSCALE_APPROVAL_POLL_INTERVAL_MS', DEFAULT_TAILSCALE_APPROVAL_POLL_INTERVAL_MS),
  };
}
