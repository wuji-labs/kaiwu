...
Kaiwu is designed around **end-to-end encryption (E2EE)**: clients encrypt session content locally and the server stores **ciphertext**.
...
- Phase 1 plaintext storage still uses the normal Kaiwu login model (device-key accounts).
