...
description: Run multiple isolated Kaiwu stacks on one machine (ports + dirs + repo pinning).
---
...
- pick or create a repo worktree for the Kaiwu monorepo
...
## Run the Kaiwu CLI against a specific stack (`stack happier`)
