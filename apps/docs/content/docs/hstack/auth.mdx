...
- it prefers authenticating against your **local stack** (not the hosted Kaiwu app)
...
- `hosted`: use the hosted web app (`https://kaiwu.chengqiyun.com`) for the approval UI (most reliable when your stack isn’t serving a web UI)
