...
Kaiwu always follows the same high-level flow:

1. **Choose a Relay** (Kaiwu Cloud by default; self-hosting is optional).
...
You use Kaiwu Cloud as your Relay.

1. Open the desktop app (recommended) or web app (status/management only).
2. Choose **Kaiwu Cloud** when the app asks you which Relay to use.
3. Sign in.
