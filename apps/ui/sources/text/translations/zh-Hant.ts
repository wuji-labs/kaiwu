...
const settingsAppearanceTranslationExtension = {
  themeProfiles: {
    ...
    editorTitle: "主題設定檔",
    activeGroup: "目前主題",
    activeFooter: "選擇介面使用的主題。可在主題畫面管理自訂主題。",
    builtInGroup: "內建主題",
    builtInFooter: "內建主題為唯讀。複製一份即可在本機自訂。",
    customGroup: "自訂主題",
    customFooter: "輕點主題即可啟用，或使用列動作進行編輯、複製或刪除。",
    defaultTheme: "預設主題",
    defaultThemeSubtitle: '使用無極開物主題色，不使用自訂配置',
    active: "使用中",
    customProfileSubtitle: "本機自訂主題設定檔",
    tapToActivate: "輕點以啟用",
    actionsGroup: "主題動作",
    createProfile: "建立主題",
    createProfileSubtitle: "基於任何內建或自訂主題開始",
    importProfile: "匯入主題",
    importProfileSubtitle: 'Paste JSON or choose a 無極開物 theme profile file',
    exportProfile: "匯出主題",
    exportProfileSubtitle: "將此主題匯出為 JSON",
    presetsGroup: "內建預設",
    presetsFooter: "內建預設為唯讀。複製一份以進行自訂。",
    presets: {
      premiumDark: "純粹深色",
      pitchDark: "極致深黑",
      sunsetDark: "日落暗影",
    ...
    clonePreset: "複製預設",
    cloneProfile: "複製設定檔",
    duplicateTheme: "建立主題複本",
    editProfile: "編輯設定檔",
    newProfileName: ({ count }: { count: number }) => `自訂主題 ${count}`,
    cloneName: ({ name }: { name: string }) => `${name} 複本`,
    detailsGroup: "詳細資訊",
    presetGroup: "預設",
    presetSource: "基礎預設",
    presetSourceSubtitle: "選擇一個主題作為起步範本",
    assetAppearance: "資產外觀",
    assetAppearanceSubtitle: "選擇此主題使用淺色還是深色應用程式圖示與資產。",
    replacePresetTitle: "取代目前色彩？",
    replacePresetSubtitle: "變更預設將會取代目前的草稿色彩，未儲存的色彩修改將會捨棄。",
    profileName: "設定檔名稱",
    editorModeGroup: "主題模式",
    editorModeFooter: "此主題用於編輯所選預設對應的色彩模式。",
    editorMode: "色彩變體",
    lightMode: "淺色",
    darkMode: "深色",
    previewTitle: "主題預覽",
    ...
    recentColors: "最近使用色彩",
    colorPickerFallback: "輸入色彩值或重複使用最近的色彩。",
    invalidColor: "請使用十六進位 hex、rgb(...)、rgba(...) 或 transparent。",
    invalidProfileName: "主題名稱無效。",
    profileLimitReached: "已達到主題數量上限。",
    contrastWarning: "此組色彩的對比度偏低，但仍可正常儲存或重設。",
    resetToken: "重設色彩值",
    resetGroup: "重設並停用",
    resetMode: "重設主題色彩",
    deactivateProfile: "使用預設主題",
    deactivateProfileSubtitle: "停用此自訂設定檔並保留已儲存的內容",
    deleteProfile: "刪除設定檔",
    deleteProfileSubtitle: "移除此本機自訂主題設定檔",
    saveAndActivate: "儲存並啟用",
    missingProfile: "找不到主題設定檔",
    importFooter: ({ formats }: { formats: string }) => `支援格式：${formats}。未知色彩變數將以警告提示。`,
    importJson: "主題 JSON",
    importJsonPlaceholder: "在此貼上主題的 JSON 資料",
    importFile: "選擇檔案",
    importWarnings: ({ count }: { count: number }) => `匯入時發現 ${count} 處警告。`,
    importErrors: {
      invalidJson: "貼上的文字不是有效的 JSON。",
      unsupportedSchema: "不支援此主題設定檔的版本。",
      invalidProfile: "無法匯入此主題設定檔。",
      tooLarge: "此主題設定檔 JSON 過大。",
    },
    exportFooter: "匯出的 JSON 包含此主題的所有公共色彩變數值。",
    exportJson: "匯出 JSON",
    copyExportJson: "複製 JSON",
    downloadExportJson: "下載 JSON",
    noProfiles: "尚無自訂主題",
    groups: {
      background: "背景",
      surface: "介面外觀",
...
const zhHantOverrides: DeepPartial<TranslationStructure> = {
  settingsKeyboard: {
      title: "鍵盤快速鍵",
      entrySubtitle: "探索並管理應用程式快速鍵",
      generalGroupTitle: "鍵盤控制",
      generalGroupFooter: "快速鍵偏好設定儲存在此裝置的本機。",
      enableShortcutsTitle: "啟用統一快速鍵",
      enableShortcutsSubtitle: "使用新的鍵盤命令註冊表處理應用程式快速鍵。",
      singleKeyTitle: "單鍵快速鍵",
      singleKeySubtitle: "未聚焦文字輸入框時允許使用例如 ? 等單鍵快速鍵。",
      conflictsTitle: ({ count }: { count: number }) => `偵測到 ${count} 處快速鍵衝突`,
      conflictsSubtitle: ({ count }: { count: number }) => `有 ${count} 個命令需要在所有快速鍵生效前進行審核。`,
      conflictsGroupTitle: "診斷",
      commandsGroupTitle: "命令",
      commandsGroupFooter: "顯示快速鍵註冊表中的預設設定。可以設定自訂快速鍵、停用命令或重設以復原預設繫結。",
      noDefaultShortcut: "無預設快速鍵",
        setCommandButton: 'Set',
        setCommandAccessibility: ({ command }: { command: string }) => `設定 ${command} 快速鍵`,
        setShortcutPromptTitle: ({ command }: { command: string }) => `設定 ${command} 的快速鍵`,
        setShortcutPromptMessage: "輸入快速鍵，例如 Alt+K、Alt+ArrowDown、Mod+Enter 或 ?。",
        setShortcutPromptPlaceholder: 'Alt+K',
        setShortcutInvalidTitle: "無效快速鍵",
        setShortcutInvalidMessage: "請輸入至少一個非變更鍵，可搭配 Mod、Ctrl、Shift 或 Alt。",
        resetCommandAccessibility: ({ command }: { command: string }) => `重設 ${command} 快速鍵`,
      commands: {
          ...
          sessionVisibleNext: '下一個可見工作階段',
            ...
            sessionsRowMoveUp: "將所選列上移",
            sessionsRowMoveDown: "將所選列下移",
            sessionsRowMoveToFolder: "將所選列移動到資料夾",
            sessionsRowMoveToWorkspaceRoot: "將所選列移動到工作區根目錄",
    ...
    connectedServices: {
        ...
        quota: {
            ...
            recoveryCreditTitle: ({ count }: { count: number }) => count === 1 ? "可用重設 1 次" : `可用重設 ${count} 次`,
            recoveryCreditSubtitle: '立即套用用量重置以恢復配額。',
            recoveryCreditExpires: ({ time }: { time: string }) => `到期時間：${time}`,
        ...
        diagnostics: {
            ...
            body: {
                ...
                provider_session_state_unavailable_for_resume: ({ reason, agentId }: { reason: string; agentId: string }) => `請檢查已連接的帳號，然後在所選帳號下全新開始，或使用目前帳號繼續。${agentId} 報告：${reason}。`,
                connected_service_materialization_identity_missing: '此工作階段缺少重用已生成提供者狀態所需的已連線服務身分。請使用所選帳號重新開始，或繼續使用目前帳號。',
                resume_reachability_inputs_missing: ({ reason, agentId }: { reason: string; agentId: string }) => `後台服務無法驗證 ${agentId} 的復原狀態，因為缺少必要的復原輸入。報告的原因：${reason}。請在所選帳號下全新開始，或使用目前帳號繼續。`,
  ...
  settings: {
        ...
        aboutFooter: '無極開物由 WUJI-Labs 出品，營運主體為乾元執中（南京）科技有限公司。預設端對端加密，可在你的其他裝置上還原帳號。與 Anthropic、OpenAI 等模型廠商無隸屬關係；Claude、Codex 等為各自所有者的商標。',
        whatsNew: '更新日誌',
    ...
    settingsProviders: {
        ...
        setup: {
            ...
            queueTitle: '供應商設定佇列',
            queueDescription: ({ provider }: { provider: string }) => `完成 ${provider}，然後繼續設定佇列中的下一個提供者。`,
  ...
  newSession: {
    ...
    commandPalette: {
        ...
        commands: {
            sessionsCategory: "工作階段",
            navigationCategory: "導覽",
            recentSessionsCategory: "最近的工作階段",
            runsCategory: "執行",
            voiceCategory: "語音",
            systemCategory: "系統",
            developerCategory: "開發者",
            newSessionTitle: "建立新工作階段",
            newSessionSubtitle: "發起一個新的對話工作階段",
            viewAllSessionsTitle: "檢視所有工作階段",
            viewAllSessionsSubtitle: "瀏覽您的聊天記錄",
            settingsTitle: "設定",
            settingsSubtitle: "設定您的偏好設定",
            accountTitle: "帳號",
            accountSubtitle: "管理您的個人帳號",
            connectTerminalTitle: "掃描 QR 碼連線終端機",
            connectTerminalSubtitle: "核准終端機中顯示的連線",
            memorySearchTitle: "搜尋記憶",
            memorySearchSubtitle: "在過去的對話中搜尋",
            sessionFallbackTitle: ({ id }: { id: string }) => `工作階段 ${id}`,
            sessionFallbackSubtitle: "切換至工作階段",
            sessionRequiredTitle: "需要工作階段",
            sessionRequiredBody: "請先開啟一個工作階段，以便此命令對其進行操作。",
            startReviewRunTitle: "啟動審查執行",
            startPlanRunTitle: "啟動規劃執行",
            startDelegationRunTitle: "啟動委派執行",
            executionRunsSubtitle: "執行流程",
            openSessionRunsTitle: "開啟工作階段執行清單",
            runsForCurrentSessionSubtitle: "目前工作階段的執行記錄",
            runsAcrossMachinesSubtitle: "跨機器的執行記錄",
            resetVoiceAgentTitle: "重設語音代理",
            voiceSubtitle: "語音",
            signOutTitle: "登出",
            signOutSubtitle: "登出您目前的帳號",
            developerMenuTitle: "開發者選單",
    ...
    server: {
        ...
        relayDrift: {
            ...
            bannerDifferentRelayDescription: ({ activeRelayUrl, daemonRelayUrl }: { activeRelayUrl: string; daemonRelayUrl: string }) => `應用端：${activeRelayUrl} · 後台服務：${daemonRelayUrl}`,
            bannerNeedsAuthTitle: '你的背景服務需要登入到此 Relay',
            bannerNeedsAuthDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) => `應用程式正在使用 ${activeRelayUrl}，但後台服務仍需審批或登入。`,
            bannerNotConfiguredTitle: '你的背景服務尚未連線到此 Relay',
            bannerNotConfiguredDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) => `應用程式正在使用 ${activeRelayUrl}，但此電腦尚未完成後台服務的連線。`,
            bannerNotInstalledTitle: '你的背景服務尚未為此 Relay 安裝',
            bannerNotInstalledDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) => `應用程式正在使用 ${activeRelayUrl}，但此電腦仍需安裝其後台服務。`,
            bannerNotRunningTitle: '你的背景服務已安裝但未執行',
            bannerNotRunningDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) => `應用程式正在使用 ${activeRelayUrl}，但後台服務已停止，需要重新啟動。`,
    ...
    sessionsList: {
        ...
        sessionFallbackLabel: "工作階段",
        moveSheetTitle: ({ item }: { item: string }) => "移動 " + item,
        moveSheetDestinationLabel: "目標位置",
        moveSheetSubmit: "移動",
        moveSheetSearchPlaceholder: "搜尋資料夾...",
        moveSheetEmpty: "沒有可移動的目標",
        moveSheetDestinations: "目的地",
        moveSheetDisabledDescendant: "無法移動到自身或子資料夾中。",
        moveSheetDisabledMaxDepth: "這會超出資料夾層級深度上限。",
        moveSheetDisabledCurrent: "已在此位置。",
        moveSheetDisabledUnavailable: "此目標位置不可用。",
        dragHandleA11yLabel: "拖曳控點",
        dragA11yPickedUp: ({ item }: { item: string }) => "已抓取 " + item + "。",
        dragA11yDroppedReorder: ({ item, destination }: { item: string; destination: string }) => "已將 " + item + " 移動到 " + destination + " 附近。",
        dragA11yDroppedNest: ({ item, destination }: { item: string; destination: string }) => "已將 " + item + " 移動到 " + destination + " 內部。",
        dragA11yDroppedRoot: ({ item, destination }: { item: string; destination: string }) => "已將 " + item + " 移動到 " + destination + "。",
        dragA11yCancelled: ({ item }: { item: string }) => "已取消移動 " + item + "。",
        dragA11yBlocked: ({ item, reason }: { item: string; reason: string }) => "無法移動 " + item + "：" + reason,
        dragA11yBlockedDescendantCycle: "目標位置位於被移動的資料夾內部",
        dragA11yBlockedLeafCannotBeParent: "工作階段不能包含其他項目",
        dragA11yBlockedMaxDepth: "已達到資料夾深度上限",
        dragA11yBlockedSamePosition: "已在該位置",
        dragA11yBlockedWorkspaceScope: "目標位置在另一個工作區中",
        dragA11yBlockedNoTarget: "未選擇目標位置",
        dragA11yBlockedDirectSession: "直連工作階段不能移動到資料夾",
        dragA11yBlockedFeatureDisabled: "工作階段資料夾未啟用",
        dragA11yBlockedUnsupportedItem: "此項目不能移動到資料夾",
        dragA11yBlockedDateOrderingMode: '工作階段順序由目前的日期排序控制。',
        selectionSelectedCount: ({ count }: { count: number }) => `已選取 ${count} 個工作階段`,
        selectionA11ySelectedCount: ({ count }: { count: number }) => `已選取 ${count} 個工作階段`,
        ...
        selectionResult: ({ succeeded, failed, skipped }: { succeeded: number; failed: number; skipped: number }) => `${succeeded} 個成功，${failed} 個失敗，${skipped} 個略過`,
        selectionDismissResultA11yLabel: '關閉所選工作階段操作結果',
        selectionConfirm: ({ action, count }: { action: string; count: number }) => `確定要對選取的 ${count} 個工作階段執行${action}嗎？`,
        selectionConfirmA11yLabel: ({ action }: { action: string }) => `確認${action}`,
        selectionMoveSheetSourceLabel: ({ count }: { count: number }) => `已選取 ${count} 個工作階段`,
        orderingMode: {
            title: '工作階段順序',
    ...
    directSessions: {
        ...
        browseSourceCodexConnectedServices: ({ service }: { service: string }) => `${service} 關聯服務`,
    ...
    executionRuns: {
        ...
        details: {
            ...
            labels: {
                status: '狀態',
                statusValue: ({ value }: { value: string }) => `狀態：${value}`,
                runId: ({ value }: { value: string }) => `執行 ID：${value}`,
                backend: ({ value }: { value: string }) => `後端：${value}`,
                permissions: ({ value }: { value: string }) => `權限：${value}`,
...
settingsSession: {
    newSessionDraftEntry: {
        ...
        subAgentGuidanceEntry: {
          ...
          promptPersonalization: {
              ...
              askAgentToRenameSessionsTitle: "工作階段標題更新",
              askAgentToRenameSessionsNeverTitle: "從不",
              askAgentToRenameSessionsNeverSubtitle: "不提示代理設定工作階段標題。",
              askAgentToRenameSessionsInitialTitle: "工作階段開始時",
              askAgentToRenameSessionsInitialSubtitle: "提示代理根據第一則使用者訊息擬定簡短標題。",
              askAgentToRenameSessionsOngoingTitle: "任務變更時",
              askAgentToRenameSessionsOngoingSubtitle: "在工作階段開始以及任務發生變更時，均提示代理設定標題。",
              askAgentToRenameSessionsInitialSelectedSubtitle: "代理會在工作階段開始時收到設定標題的提示。",
              askAgentToRenameSessionsOngoingSelectedSubtitle: "代理會在任務變更時收到更新標題的提示。",
              askAgentToRenameSessionsDisabledSubtitle: "不提示代理設定標題；手動重新命名仍然有效。",
              askAgentToSuggestReplyOptionsTitle: "請求代理建議回覆選項",
              askAgentToSuggestReplyOptionsEnabledSubtitle: "提示詞會在適當時讓代理提供快速回覆選項。",
    ...
    welcome: {
        ...
        manualDisclosure: {
            ...
            subtitle: {
                ...
                connectMachine: ({ targetLabel }: { targetLabel: string }) => `使用桌面端引導流程將此電腦連接到 ${targetLabel}。僅在偏好終端機方式時開啟手動步驟。`,

                startDaemon: ({ targetLabel }: { targetLabel: string }) => `使用桌面端引導流程為 ${targetLabel} 重新連接後台服務。僅在已位於該電腦上時開啟手動步驟。`,
    ...
    setupOnboarding: {
        ...
        currentRelayDescription: ({ relayUrl }: { relayUrl: string }) => `已選 Relay：${relayUrl}`,
    ...
    profiles: {
        ...
        builtInNames: {
            anthropic: 'Anthropic（預設）',
            deepseek: 'DeepSeek（推理）',
            zai: 'Z.AI (GLM-4.6)',
            minimax: "MiniMax (M3)",
            minimaxCn: "MiniMax (M3, 國內)",
            codex: 'Codex（預設）',
            openai: "OpenAI (GPT-5)",
