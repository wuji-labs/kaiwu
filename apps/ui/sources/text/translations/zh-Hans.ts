/**
 * Chinese (Simplified) translations for the 无极开物 app
 * Values can be:
...
const mcpServersUxTranslationExtension = {
  ...
  mcpServersHeroSubtitle: ({ configuredCount }: { configuredCount: number }) => `在无极开物中已配置 ${configuredCount} 个`,
  mcpServersHeroSubtitleEmpty: '只需创建一次服务器，预览它们适用的位置，并导入其他工具已经在使用的配置。',
  mcpServersSegmentConfigured: '已配置',
  mcpServersSegmentConfiguredSubtitle: '你的无极开物目录',
  ...
  mcpServersPreviewRefreshSubtitle: '为此上下文解析无极开物和提供方原生 MCP 服务器',
  ...
  mcpServersBuiltInDescription: '在无极开物会话中始终可用。',
  mcpServersSourceHappier: '无极开物',
  ...
  mcpServersEditorAppliesToSubtitle: '选择无极开物默认应将此服务器添加到哪里。',
...
const newSessionMcpTranslationExtension = {
  ...
  mcpDetectedUnsupportedSubtitle: '更新此机器上的无极开物以启用提供商配置扫描。',
  mcpHappierSectionTitle: '无极开物 MCP 服务器',
  mcpHappierEmptyTitle: '无极开物中未定义 MCP 服务器',
...
const settingsAppearanceTranslationExtension = {
  themeProfiles: {
    ...
    editorTitle: "主题配置",
    activeGroup: "当前主题",
    activeFooter: "选择界面使用的主题。可在主题页面管理自定义主题。",
    builtInGroup: "内置主题",
    builtInFooter: "内置主题为只读。复制一份即可在本地自定义。",
    customGroup: "自定义主题",
    customFooter: "点击主题即可激活，或使用行操作进行编辑、复制或删除。",
    defaultTheme: "默认主题",
    defaultThemeSubtitle: '使用无极开物主题色，不使用自定义配置',
    active: "生效中",
    customProfileSubtitle: "本地自定义主题配置",
    tapToActivate: "点击以激活",
    actionsGroup: "主题操作",
    createProfile: "创建主题",
    createProfileSubtitle: "基于任意内置或自定义主题开始",
    importProfile: "导入主题",
    importProfileSubtitle: 'Paste JSON or choose a 无极开物 theme profile file',
    exportProfile: "导出主题",
    exportProfileSubtitle: "将此主题导出为 JSON",
    presetsGroup: "内置预设",
    presetsFooter: "内置预设为只读。克隆一份以进行自定义。",
    presets: {
      premiumDark: "纯粹深色",
      pitchDark: "极致深黑",
      sunsetDark: "日落暗影",
    ...
    presetGroup: "预设",
    presetSource: "基础预设",
    presetSourceSubtitle: "选择一个主题作为起步模板",
    assetAppearance: "资源外观",
    assetAppearanceSubtitle: "选择此主题使用浅色还是深色应用图标与资产。",
    replacePresetTitle: "替换当前颜色？",
    replacePresetSubtitle: "更换预设将替换当前的草稿颜色，未保存的颜色修改将被放弃。",
    profileName: "配置名称",
    editorModeGroup: "主题模式",
    editorModeFooter: "此主题用于编辑所选预设对应的颜色模式。",
    editorMode: "色彩变体",
    lightMode: "浅色",
    darkMode: "深色",
    previewTitle: "主题预览",
    ...
    recentColors: "最近使用颜色",
    colorPickerFallback: "输入颜色值或复用最近的颜色。",
    invalidColor: "请使用十六进制 hex、rgb(...)、rgba(...) 或 transparent。",
    invalidProfileName: "主题名称无效。",
    profileLimitReached: "已达到主题数量上限。",
    contrastWarning: "此组颜色的对比度偏低，但仍可正常保存或重置。",
    resetToken: "重置颜色值",
    resetGroup: "重置并停用",
    resetMode: "重置主题颜色",
    deactivateProfile: "使用默认主题",
    deactivateProfileSubtitle: "停用此自定义配置并保留已保存的内容",
    deleteProfile: "删除配置",
    deleteProfileSubtitle: "移除此本地自定义主题配置",
    saveAndActivate: "保存并激活",
    missingProfile: "未找到主题配置",
    importFooter: ({ formats }: { formats: string }) => `支持格式：${formats}。未知颜色变量将作为警告提示。`,
    importJson: "主题 JSON",
    importJsonPlaceholder: "在此粘贴主题的 JSON 数据",
    importFile: "选择文件",
    importWarnings: ({ count }: { count: number }) => `导入时发现 ${count} 处警告。`,
    importErrors: {
      invalidJson: "粘贴的文本不是有效的 JSON。",
      unsupportedSchema: "不支持此主题配置的版本。",
      invalidProfile: "无法导入此主题配置。",
      tooLarge: "此主题配置 JSON 过大。",
    },
    exportFooter: "导出的 JSON 包含此主题的所有公共颜色变量值。",
    exportJson: "导出 JSON",
    copyExportJson: "复制 JSON",
    downloadExportJson: "下载 JSON",
    noProfiles: "暂无自定义主题",
    groups: {
      background: "背景",
      surface: "表面",
...
const memoryEmbeddingsTranslationExtension = {
  ...
  embeddings: {
    ...
    provider: {
      ...
      options: {
        localTitle: '本地模型',
        localSubtitle: '由无极开物管理，并在首次使用时下载',
...
const promptLibraryUxRefinementTranslationExtension = {
  zhHans: {
    ...
    externalAssetsInstallMethodSymlinkSubtitle: '将目标链接到无极开物管理的副本，便于后续更新',
    ...
    registriesItemImportSubtitle: '将此技能包导入无极开物资料库',
...
const sessionHandoffTranslationExtensions = {
  'zh-Hans': {
    activeWarning: {
      title: '此会话仍在此设备上运行',
      message: '开始移交前，无极开物会先在这台设备上停止此会话，然后再将其转移到所选设备。',
      confirm: '在此停止并移交',
    },
    progress: {
      title: '正在移交会话',
    ...
    recovery: {
      ...
      messageAfterSourceStop:
        '无极开物已经在这台设备上停止了此会话，但未能在目标设备上完成启动。你可以在这里重新启动，或在恢复目标设备期间保持其停止状态。',
...
const settingsSessionHandoffTranslationExtensions = {
  'zh-Hans': {
    ...
    directTargetMode: {
      ...
      convertToPersistedTitle: '转换为无极开物',
      convertToPersistedSubtitle: '导入会话记录，并作为无极开物会话继续。',
    },
  },
} as const;
...
export const zhHans: TranslationStructure = {
    settingsKeyboard: {
        title: "键盘快捷键",
        entrySubtitle: "查看并管理应用快捷键",
        generalGroupTitle: "键盘控制",
        generalGroupFooter: "快捷键偏好设置保存在此设备的本地。",
        enableShortcutsTitle: "启用统一快捷键",
        enableShortcutsSubtitle: "使用新的键盘命令注册表处理应用快捷键。",
        singleKeyTitle: "单键快捷键",
        singleKeySubtitle: "未聚焦文本输入框时允许使用例如 ? 等单键快捷键。",
        conflictsTitle: ({ count }: { count: number }) => `检测到 ${count} 处快捷键冲突`,
        conflictsSubtitle: ({ count }: { count: number }) => `有 ${count} 个命令需要在所有快捷键生效前进行审核。`,
        conflictsGroupTitle: "诊断",
        commandsGroupTitle: "命令",
        commandsGroupFooter: "显示快捷键注册表中的默认配置。可以设置自定义快捷键、禁用命令或重置以恢复默认绑定。",
        noDefaultShortcut: "无默认快捷键",
        setCommandButton: 'Set',
        setCommandAccessibility: ({ command }: { command: string }) => `设置 ${command} 快捷键`,
        setShortcutPromptTitle: ({ command }: { command: string }) => `设置 ${command} 的快捷键`,
        setShortcutPromptMessage: "输入快捷键，例如 Alt+K、Alt+ArrowDown、Mod+Enter 或 ?。",
        setShortcutPromptPlaceholder: 'Alt+K',
        setShortcutInvalidTitle: "无效快捷键",
        setShortcutInvalidMessage: "请输入至少一个非修饰键，可搭配 Mod、Ctrl、Shift 或 Alt。",
        resetCommandAccessibility: ({ command }: { command: string }) => `重置 ${command} 快捷键`,
        commands: {
            ...
            sessionsRowMoveUp: "将所选行上移",
            sessionsRowMoveDown: "将所选行下移",
            sessionsRowMoveToFolder: "将所选行移动到文件夹",
            sessionsRowMoveToWorkspaceRoot: "将所选行移动到工作区根目录",
  ...
  appCrash: {
    title: "出错了",
    subtitle: "无极开物发生了意外错误。你可以重启应用界面，或复制详细信息以便支持排查。",
    detailsTitle: "错误详情",
    restart: "重启应用",
  ...
  connect: {
    ...
    scanComputerQrInstructions: "扫描电脑端无极开物（设置 → 添加手机）中显示的二维码。",
    scanComputerQrButton: "扫描二维码登录",
    waitingForApproval: "等待确认…",
    showQrInstead: "改为显示二维码",
    addPhoneQrInstructions: "用无极开物手机应用扫描此二维码，在手机上登录。",
    ...
    externalAuthVerifiedBody: ({ provider }: { provider: string }) =>
      `我们找到了与 ${provider} 关联的现有无极开物账户。要在此设备上完成登录，请使用二维码或你的密钥恢复账户密钥。`,
    restoreWithSecretKeyInstead: "改用密钥恢复",
    restoreWithSecretKeyDescription: "输入你的密钥以恢复账户访问权限。",
    lostAccessLink: "无法访问？",
    lostAccessTitle: "无法访问你的账户？",
    lostAccessBody:
      "如果你已没有任何设备与此账户关联，并且丢失了密钥，你可以通过身份提供方重置账户。这将创建一个新的无极开物账户。旧的加密历史无法恢复。",
    ...
    linkNewDeviceQrInstructions: "在新设备上打开无极开物并显示二维码",
  ...
  bugReports: {
    composer: {
      ...
      issueDetails: {
        ...
        reproductionStepsPlaceholder: "1. 打开无极开物\n2. 开始一个会话\n3. ...",
  ...
  memorySearchSettings: {
    ...
    enabled: {
      ...
      footer:
        "启用后，无极开物会基于已解密的对话记录在设备本地构建索引，以支持快速回忆与搜索。",
    },
    budgets: {
      groupTitle: "磁盘配额",
    ...
    status: {
      ...
      diskUsageFormatted: ({ light, deep }: { light: string; deep: string }) => `轻量 ${light} · 深度 ${deep}`,
  ...
  subAgentGuidance: {
    ruleEditor: {
      ...
      enableInjection: {
        title: "无极开物运行指令",
        subtitle: "关闭后，编码代理的系统提示词中将移除原生优先路由说明和无极开物运行机制。",
      },
      characterBudget: {
        title: "自定义规则字符上限",
  ...
  settings: {
    ...
    machineSetupCurrentMachineSubtitle: "直接在此设备上初始化无极开物",
    ...
    machineSetupStageInstall: "安装无极开物并配对设备",
  ...
  connectedServices: {
    ...
    quota: {
      ...
      recoveryCreditTitle: ({ count }: { count: number }) => count === 1 ? "可用重置 1 次" : `可用重置 ${count} 次`,
      recoveryCreditSubtitle: "立即应用用量重置以恢复配额。",
      recoveryCreditExpires: ({ time }: { time: string }) => `过期时间：${time}`,
    ...
    oauthPaste: {
      ...
      connectWebDescription:
        "打开授权 URL，在浏览器中完成 OAuth，然后将最终重定向的 URL 复制并粘贴回无极开物。",
    ...
    diagnostics: {
      ...
      body: {
        default: "检查已连接账号后重试。",
        provider_session_state_unavailable_for_resume: ({ reason, agentId }: { reason: string; agentId: string }) => `请检查已连接的账号，然后在所选账号下全新开始，或使用当前账号继续。${agentId} 报告：${reason}。`,
        connected_service_materialization_identity_missing: "此会话缺少复用已物化提供商状态所需的已连接服务身份。请使用所选账号重新开始，或继续使用当前账号。",
        resume_reachability_inputs_missing: ({ reason, agentId }: { reason: string; agentId: string }) => `后台服务无法验证 ${agentId} 的恢复状态，因为缺少必要的恢复输入。报告的原因：${reason}。请在所选账号下全新开始，或使用当前账号继续。`,
        metadata_update_failed: "会话无法保存新的身份验证选择。请在会话同步完成后重试。",
        no_eligible_group_member: "此池中当前没有符合备用条件的账号。请检查已连接账号，并在需要时重新连接配置文件。",
        recovery_retry_scheduled: "无极开物已计划重试提供商恢复。你可以立即重试或检查已连接账号。",
        recovery_dead_lettered: "无极开物已耗尽自动提供商恢复重试。请检查已连接账号或重新连接所选配置文件。",
        runtime_auth_recovery_superseded: "这次提供商恢复尝试已被更新的连接服务状态取代。无极开物不会继续重试这个过期账号。",
        runtime_auth_generation_stale: "这次提供商恢复尝试属于较旧的连接服务代次。请等待最新切换完成，或检查已连接账号。",
        hot_apply_unavailable: "该提供商无法在正在运行的会话中安全切换身份验证。无极开物会等待安全重启或下一个可用的恢复路径。",
        app_server_unavailable: "提供商应用服务器无法用于验证或应用身份验证切换。请在会话准备好后重试。",
        provider_account_adoption_mismatch: "切换后提供商仍停留在其他账号。请检查已连接账号或重试切换。",
        provider_account_identity_unverified: "无极开物无法证明当前提供商账号身份。在获得更强证明前，它会避免向同一账号分发。",
        post_switch_verification_failed: "无极开物无法验证提供商是否采用了所选账号。请检查已连接账号或重试切换。",
        quota_snapshot_stale: "最新配额快照太旧，无法驱动主动切换。无极开物会继续使用被动恢复，直到有新的配额数据。",
        quota_fetch_disabled: "该提供商当前已禁用配额检查。无极开物会继续使用被动恢复。",
        quota_fetch_backoff: "收到提供商或网络响应后，配额检查暂时退避。无极开物稍后会重试刷新配额。",
        auth_surface_weakly_verified: "无极开物已验证所选身份验证文件已被重写，但该提供商不公开确切的当前账号身份。",
        connected_service_restart_requested: "无极开物已请求安全重启会话，以应用所选的已连接账户。",
        ...
        claude_subscription_native_auth_materialization_failed: "无极开物无法为此配置创建 Claude Code 原生凭据文件。请重新连接该配置，或选择账号池中的其他成员。",
    ...
    detail: {
      ...
      openGithubTokenTemplateSubtitle: "打开 GitHub，并预填无极开物需要的权限",
      ...
      groupDetail: {
        ...
        softSwitchThresholdPromptBody: "输入剩余百分比，无极开物将在该值以下优先选择此多账号池中更安全的成员。使用 0 可关闭预防性切换。",
        ...
        staleProbePromptBody: "输入配额数据可重复使用的分钟数，超过后无极开物会重新检查。",
  ...
  settingsDesktop: {
    ...
    startOnLoginSubtitle: '当你登录这台电脑时自动启动无极开物。',
  },
  ...
  settingsPets: {
    ...
    helpDocsTitle: '宠物帮助',
    helpDocsSubtitle: '打开无极开物文档以查看设置和故障排除。',
    ...
    detectedCodexPetsNoTargetSubtitle: '在此电脑上启动无极开物，然后再次检测 Codex 宠物。',
  ...
  settingsNotifications: {
    ...
    connectedServices: {
      ...
      accountSwitch: {
        title: "账户切换",
        subtitle: "当无极开物自动将提供商切换到另一个已连接账户时通知",
      },
      quotaBlocked: {
        title: "配额受阻",
    ...
    pushPriming: {
        title: '开启通知？',
        body: '无极开物可以在智能体完成工作、需要权限决定或正在等待你时通知你。你随时可以在设置中更改。',
        accept: '开启',
        decline: '暂不',
        blockedTitle: '通知已被阻止',
  ...
  settingsProviders: {
    ...
    setup: {
        ...
        queueTitle: '提供商设置队列',
        queueDescription: ({ provider }: { provider: string }) => `完成 ${provider}，然后继续配置队列中的下一个提供商。`,
    ...
    cliSourcePreference: {
      title: "CLI 来源偏好",
      subtitle: "当系统 CLI 和无极开物管理安装同时存在时，选择优先使用哪一个。",
      options: {
        systemFirst: {
          title: "优先系统安装",
    ...
    plugins: {
            claude: {
                ...
                sections: {
                    claudeUnifiedTerminal: {
                        title: "统一终端运行时",
                        footer: "启用后，无极开物会把提示发送到同一个 Claude Code 终端会话，而不是启动单独的 Agent SDK runner。"
                    },
                    claudeCodeExperiments: {
                        title: "Claude Code 实验功能",
                        footer: "这些设置同时适用于由无极开物启动的 Claude 本地会话（终端）和远程会话（Agent SDK）。"
                    },
                    claudeRemoteSdk: {
                ...
                fields: {
                    ...
                    claudeUnifiedTerminalHost: {
                        title: "终端主机",
                        subtitle: "选择无极开物如何托管共享的 Claude 终端会话。",
                        options: {
                            auto: {
                                title: "自动",
                            ...
                            zellij: {
                                title: "zellij",
                                subtitle: "使用无极开物内置的 zellij 主机。"
                            }
                        }
                    },
                    claudeUnifiedTerminalResumeChoice: {
                        title: "大型会话恢复",
                        subtitle: "选择当 Claude 询问如何恢复大型会话时无极开物的响应方式。",
                        options: {
                            ask_every_time: {
                                title: "每次询问",
                    ...
                    claudeUnifiedTerminalWorkspaceTrust: {
                        title: "工作区信任",
                        subtitle: "选择当 Claude 询问是否信任工作区时无极开物的响应方式。",
                        options: {
                            ask_every_time: {
                                title: "每次询问",
                            ...
                            always_trust_happier_workspaces: {
                                title: "始终信任无极开物工作区",
                                subtitle: "信任无极开物打开的工作区中当前重新捕获的 Claude 提示。"
                            },
                            always_reject_happier_workspaces: {
                                title: "始终拒绝无极开物工作区",
                                subtitle: "拒绝无极开物打开的工作区中当前重新捕获的 Claude 提示。"
                            }
                        }
                    },
                    claudeCodeExperimentalAgentTeamsEnabled: {
                        title: "强制启用 Agent Teams",
                        subtitle: "在所有由无极开物启动的 Claude 会话中启用 Claude Code 的实验性 Agent Teams（代理群）功能。"
                    },
                    claudeRemoteAgentSdkEnabled: {
                        title: "使用 Agent SDK 回退",
                        subtitle: "当统一终端运行时关闭时，通过 Agent SDK 运行由无极开物控制的 Claude 会话。"
                    },
                    ...
                    claudeLocalPermissionBridgeEnabled: {
                        title: "实验性：本地权限桥接",
                        subtitle: "将 Claude 本地模式的权限请求转发到无极开物，以便你可以在界面中批准或拒绝。"
                    },
                    claudeLocalPermissionBridgeWaitIndefinitely: {
                        title: "保持请求打开直到回应",
                        subtitle: "启用后，无极开物会一直保持 Claude 本地权限请求处于待处理状态，直到你在界面中批准或拒绝。"
                    },
                    claudeLocalPermissionBridgeTimeoutSeconds: {
                        title: "可选权限超时（秒）",
                        subtitle: "仅在关闭无限等待时使用。超过该时间后，无极开物会回退到 Claude 的终端提示。"
                    },
            ...
            opencode: {
                ...
                sections: {
                    ...
                    server: {
                        title: "服务器连接",
                        footer: "留空即可使用无极开物管理的 OpenCode 服务器生命周期。设置绝对 http(s) URL 以连接到现有 OpenCode 服务器。"
                    }
                },
                fields: {
                    opencodeBackendMode: {
            ...
            cursor: {
                ...
                sections: {
                    cli: {
                        title: "Cursor 命令行",
                        footer: "当自动检测不足时，使用指定的 Cursor 二进制文件。无极开物优先使用 cursor-agent，并可在启用时回退到 agent。"
                    }
                },
                fields: {
                    cursorBinaryPath: {
            ...
            kimi: {
                ...
                fields: {
                    kimiAcpPythonSelector: {
                        ...
                        subtitle: "选择无极开物如何启动 Kimi ACP 的 Python stdio 循环。",
                        options: {
                            auto: {
                                title: "自动",
  ...
  settingsFeatures: {
    ...
    expChannelBridgesSubtitle: "将 Telegram 等聊天渠道连接到无极开物会话（实验性）",
    ...
    expSessionsFoldersSubtitle: "用工作区文件夹整理无极开物侧边栏会话",
    expPetsCompanion: "宠物",
  ...
  errors: {
    ...
    permissionCanceledSessionInactive: "会话处于非活动状态 — 无法批准此权限请求。",
      ...
      daemonUnavailableBody:
        "无极开物无法连接到此设备上的守护进程。它可能离线、仍在启动，或与服务器断开连接。",
      tryAgain: "请重试",
    ...
    providerAlreadyLinked: ({ provider }: { provider: string }) =>
      `${provider} 已关联到现有的无极开物账号。要在此设备上登录，请从已登录的设备中将此设备进行关联。`,
  ...
  deps: {
    installNotSupported: "请更新无极开物 CLI 以安装此依赖项。",
    installFailed: "安装失败",
    installed: "已安装",
  ...
  newSession: {
    ...
    noMachinesFound: "未找到设备。请先在您的计算机上启动无极开物会话。",
    ...
    launchStillPendingBody:
      "无极开物尚未确认新会话。启动请求仍已保存。请重试以继续同一次启动，不会创建重复会话。",
    ...
    resume: {
      ...
      cannotApplyBody: "此恢复 ID 当前无法应用。无极开物将改为启动一个新会话。",
    },
    codexResumeBanner: {
      title: "Codex 恢复服务器",
    ...
    githubCliInstallModal: {
      ...
      description:
        "这会安装 GitHub CLI，以便无极开物在 pull request 流程中使用你的本地 GitHub 身份验证。",
    },
  },
  ...
  session: {
    ...
    agentContinuation: {
      ...
      handedOver: {
          ...
          unavailableSource: "无极开物无法读取本会话的转录，因此无法重建此内容。",
          unreachable: "无极开物无法连接到托管本会话的机器。",
          retryAction: "重试",
      ...
      transition: {
        ...
        resumeAction: '恢复会话',
        unknown: '无极开物无法确认发生了什么。请先检查此会话再重新发送。',
      },
    },
    sourceContext: {
        ...
        removeA11y: "移除来源对话",
        keepAction: "保留",
        serverMismatch: "该对话位于另一台无极开物服务器上。请切换回那台服务器，或移除来源对话以重新开始。",
    },
    forking: {
      ...
      strategy: {
          ...
          replay: {
              title: "Replay 分叉",
              subtitle: "无极开物会重放目前的对话，作为新会话的上下文。",
          },
          configure: {
              title: "配置新会话",
	    ...
	    mcpRestartRequired: {
	        ...
	        failureBody: "无极开物无法重启此运行器。你的 MCP 选择已保存，并会在下次启动时应用。",
	        restartAction: "重启会话",
	        restartPendingAction: "正在重启…",
	        badgeLabel: "MCP 更改",
	    ...
	    resumeSupportNoteChecking:
	      "注意：无极开物仍在检查此机器是否可以恢复提供方会话。",
	    resumeSupportNoteUnverified: "注意：无极开物无法验证此机器的恢复支持情况。",
    ...
    machineOfflineNoticeTitle: "机器离线",
      machineOfflineNoticeBody: ({ machine }: { machine: string }) =>
        `“${machine}” 处于离线状态。你现在可以将消息加入队列；机器恢复在线后，无极开物将继续处理。`,
    machineOfflineCannotResume: "机器离线。请将其恢复在线后再恢复此会话。",
      ...
      subagents: {
        messages: {
          teamLabel: ({ teamId }: { teamId: string }) => `团队：${teamId}`,
          memberLabel: ({ memberLabel, teamId }: { memberLabel: string; teamId: string }) => `${memberLabel} · ${teamId}`,
          launch: {
    ...
    reviewFindings: {
      ...
      pendingMessages: {
        ...
        discardConfirm: {
          title: "丢弃待发送消息？",
          body: "这会保留一份已丢弃副本，并阻止无极开物投递这条待发送消息。",
        },
        markHandledConfirm: {
          title: "将待发送消息标记为已处理？",
          body: "仅当提供商已处理该消息，或你不再希望无极开物投递它时使用。",
        },
        dismissDeliveryConfirm: {
          title: "忽略结果不确定的投递？",
          body: "这会归档原消息，不会再次发送。如果提供商之后确认已投递，无极开物仍可将原消息加入对话记录。",
        },
        sendAsNewConfirm: {
          title: "将此消息作为新消息发送？",
        ...
        errors: {
          ...
          clearTerminalComposerUnsupported: "此会话不支持从无极开物清空终端输入框。",
  ...
  commandPalette: {
    ...
    noCommandsFound: "未找到命令",
        ...
        commands: {
            ...
            recentSessionsCategory: "最近会话",
            runsCategory: "运行",
            voiceCategory: "语音",
            systemCategory: "系统",
            developerCategory: "开发者",
            newSessionTitle: "新建会话",
            newSessionSubtitle: "发起一个新的对话会话",
            viewAllSessionsTitle: "查看所有会话",
            viewAllSessionsSubtitle: "浏览您的聊天记录",
            settingsTitle: "设置",
            settingsSubtitle: "配置您的偏好设置",
            accountTitle: "账号",
            accountSubtitle: "管理您的个人账号",
            connectTerminalTitle: "扫码连接终端",
            connectTerminalSubtitle: "在终端中批准显示的连接",
            memorySearchTitle: "搜索记忆",
            memorySearchSubtitle: "在过去的对话中搜索",
            sessionFallbackTitle: ({ id }: { id: string }) => `会话 ${id}`,
            sessionFallbackSubtitle: "切换到此会话",
            sessionRequiredTitle: "需要会话",
            sessionRequiredBody: "请先打开一个会话，以便此命令对其进行操作。",
            startReviewRunTitle: "启动审查运行",
            startPlanRunTitle: "启动规划运行",
            startDelegationRunTitle: "启动委托运行",
            executionRunsSubtitle: "执行运行",
            openSessionRunsTitle: "打开会话运行列表",
            runsForCurrentSessionSubtitle: "当前会话的运行记录",
            runsAcrossMachinesSubtitle: "跨机器的运行记录",
            resetVoiceAgentTitle: "重置语音代理",
            voiceSubtitle: "语音",
            signOutTitle: "退出登录",
            signOutSubtitle: "退出当前登录的账号",
  ...
  server: {
    ...
    notValidHappyServer: "不是有效的无极开物 Relay",
    ...
    relayDrift: {
        ...
        bannerDifferentRelayDescription: ({ activeRelayUrl, daemonRelayUrl }: { activeRelayUrl: string; daemonRelayUrl: string }) => `应用端：${activeRelayUrl} · 后台服务：${daemonRelayUrl}`,
        bannerNeedsAuthTitle: '你的后台服务需要登录到此 Relay',
        bannerNeedsAuthDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) => `应用端正在使用 ${activeRelayUrl}，但后台服务仍需审批或登录。`,
        bannerNotConfiguredTitle: '你的后台服务尚未连接到此 Relay',
        bannerNotConfiguredDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) => `应用端正在使用 ${activeRelayUrl}，但此计算机尚未完成后台服务的连接。`,
        bannerNotInstalledTitle: '你的后台服务尚未为此 Relay 安装',
        bannerNotInstalledDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) => `应用端正在使用 ${activeRelayUrl}，但此计算机仍需安装其后台服务。`,
        bannerNotRunningTitle: '你的后台服务已安装但未运行',
        bannerNotRunningDescription: ({ activeRelayUrl }: { activeRelayUrl: string }) => `应用端正在使用 ${activeRelayUrl}，但后台服务已停止，需要重新启动。`,
  ...
  sessionsList: {
    ...
    moveToWorkspaceRoot: '工作区根目录',
        ...
        moveSheetTitle: ({ item }: { item: string }) => "移动 " + item,
        moveSheetDestinationLabel: "目标位置",
        moveSheetSubmit: "移动",
        moveSheetSearchPlaceholder: "搜索文件夹...",
        moveSheetEmpty: "没有可移动的目标",
        moveSheetDestinations: "目标位置",
        moveSheetDisabledDescendant: "不能移动到自身或子文件夹中。",
        moveSheetDisabledMaxDepth: "这会超出文件夹层级深度上限。",
        moveSheetDisabledCurrent: "已在此位置。",
        moveSheetDisabledUnavailable: "此目标位置不可用。",
        dragHandleA11yLabel: "拖拽手柄",
        dragA11yPickedUp: ({ item }: { item: string }) => "已提起 " + item + "。",
        dragA11yDroppedReorder: ({ item, destination }: { item: string; destination: string }) => "已将 " + item + " 移动到 " + destination + " 附近。",
        dragA11yDroppedNest: ({ item, destination }: { item: string; destination: string }) => "已将 " + item + " 移动到 " + destination + " 内部。",
        dragA11yDroppedRoot: ({ item, destination }: { item: string; destination: string }) => "已将 " + item + " 移动到 " + destination + "。",
        dragA11yCancelled: ({ item }: { item: string }) => "已取消移动 " + item + "。",
        dragA11yBlocked: ({ item, reason }: { item: string; reason: string }) => "无法移动 " + item + "：" + reason,
        dragA11yBlockedDescendantCycle: "目标位置位于被移动的文件夹内部",
        dragA11yBlockedLeafCannotBeParent: "会话不能包含其他项目",
        dragA11yBlockedMaxDepth: "已达到文件夹深度上限",
        dragA11yBlockedSamePosition: "已在该位置",
        dragA11yBlockedWorkspaceScope: "目标位置在另一个工作区中",
        dragA11yBlockedNoTarget: "未选择目标位置",
        dragA11yBlockedDirectSession: "直连会话不能移动到文件夹",
        dragA11yBlockedFeatureDisabled: "会话文件夹未启用",
        dragA11yBlockedUnsupportedItem: "此项目不能移动到文件夹",
        dragA11yBlockedDateOrderingMode: '会话顺序由当前日期排序控制。',
        selectionSelectedCount: ({ count }: { count: number }) => `已选 ${count} 个会话`,
        selectionA11ySelectedCount: ({ count }: { count: number }) => `已选 ${count} 个会话`,
        ...
        selectionProgress: ({ completed, total }: { completed: number; total: number }) => `已完成 ${completed} / ${total}`,
        selectionCancelRunningA11yLabel: '取消所选会话操作',
        selectionResult: ({ succeeded, failed, skipped }: { succeeded: number; failed: number; skipped: number }) => `${succeeded} 个成功，${failed} 个失败，${skipped} 个跳过`,
        selectionDismissResultA11yLabel: '关闭所选会话操作结果',
        selectionConfirm: ({ action, count }: { action: string; count: number }) => `确定要对选中的 ${count} 个会话执行${action}吗？`,
        selectionConfirmA11yLabel: ({ action }: { action: string }) => `确认${action}`,
        selectionMoveSheetSourceLabel: ({ count }: { count: number }) => `已选 ${count} 个会话`,
        orderingMode: {
            title: '会话顺序',
  ...
  directSessions: {
    ...
    browseSourceCodexConnectedServices: ({ service }: { service: string }) => `${service} 关联服务`,
    ...
    stopSessionControlUnavailable: "无极开物无法连接会话控制。请确认会话所在机器和守护进程在线，然后重试。",
    archiveSession: "归档会话",
    ...
    locationLabel: "位置",
    checkoutLabel: "检出",
    happySessionIdCopied: "无极开物会话 ID 已复制到剪贴板",
    failedToCopySessionId: "复制无极开物会话 ID 失败",
    happySessionId: "无极开物会话 ID",
  ...
  workflowActivityView: {
    ...
    acpHistoryImport: {
      title: "导入会话历史记录？",
      defaultNote:
        "此会话历史记录与无极开物中已有内容不同。导入可能会产生重复项。",
      counts: {
  ...
  files: {
    ...
    branchMenu: {
      ...
      indexLock: {
        title: "移除过期的 Git 锁？",
        body: "Git 报告存在索引锁。如果没有其他 Git 命令正在运行，无极开物可以移除这个过期锁并重试。",
        confirm: "移除锁并重试",
    ...
    stagedChanges: ({ count }: { count: number }) => `已暂存的更改 (${count})`,
      ...
      fileEditingUnsupported:
        "连接的守护进程不支持文件编辑。请在该机器上更新无极开物以启用写入操作。",
      ...
      loadingFile: ({ fileName }: { fileName: string }) =>
        ...
        mediaPreviewTooLarge: '媒体或文档文件过大，无法在应用内预览',
        legacyOfficeFormat: '旧版 Office 格式暂不支持应用内预览，请转存为新版格式（.docx / .xlsx / .pptx）后再查看。',
        pdfPreviewFailed: 'PDF 预览加载失败',
        officePreviewFailed: 'Office 文档预览加载失败',
        audioPlaybackFailed: '音频播放失败',
        videoPlaybackFailed: '视频播放失败',
        play: '播放',
        pause: '暂停',
        pptxSlide: ({ current, total }: { current: number; total: number }) => `第 ${current} / ${total} 页`,
        pptxEmpty: '幻灯片中未找到可展示的内容',
    ...
    sourceControlOperations: {
      ...
      update: {
        ...
        pullRequests: {
          ...
          featureBranchPromptBody: "无极开物会先检出此分支再继续。",
  ...
  executionRuns: {
    ...
    details: {
      ...
      labels: {
        status: "状态",
        statusValue: ({ value }: { value: string }) => `状态：${value}`,
        runId: ({ value }: { value: string }) => `运行 ID：${value}`,
        backend: ({ value }: { value: string }) => `后端：${value}`,
        permissions: ({ value }: { value: string }) => `权限：${value}`,
        mode: ({ value }: { value: string }) => `模式：${value}`,
        intent: "意图",
        backendId: "后端 ID",
        permissionMode: "权限模式",
      ...
      settingsActions: {
        ...
        spawnPolicy: {
            title: "AI 会话创建策略",
            footer: "这些控制项仅在无极开物会话内的助手创建另一个会话时生效。继承自父会话的设置仍会被允许；被拒绝的项目会用清晰错误拒绝显式覆盖。",
            toggles: {
        ...
        targets: {
            ...
            session_agent: {
                title: 'AI 会话',
                subtitle: '控制在无极开物会话内运行的助手可用的工具。',
            },
            mcp: {
                title: 'MCP',
                subtitle: '控制使用无极开物 MCP 操作目录的外部 MCP 客户端。',
            },
            cli: {
                title: '会话控制 CLI',
...
settingsSession: {
    ...
    messageSending: {
      ...
      inactiveResumePolicySubtitle: "选择向非活动会话发送消息后无极开物应执行的操作。",
      ...
      nonSteerablePromptFooter: '权限模式更改以及 /clear 或 /compact 无法在回合中途生效。选择智能体忙碌时无极开物如何处理此类消息。',
      nonSteerablePrompt: {
        askTitle: '每次询问',
    ...
    sessionCreation: {
      ...
      wizardPresentationDropdownSubtitle: "显示一个可打开完整选择器的紧凑行。",
          ...
          promptPersonalization: {
              title: "提示词个性化",
              footer: 'Choose which built-in instructions 无极开物 adds to new agent sessions. This does not hide options an agent already sends.',
              askAgentToRenameSessionsTitle: "会话标题更新",
              askAgentToRenameSessionsNeverTitle: "从不",
              askAgentToRenameSessionsNeverSubtitle: "不提示智能体设置会话标题。",
              askAgentToRenameSessionsInitialTitle: "会话开始时",
              askAgentToRenameSessionsInitialSubtitle: "提示智能体根据第一条用户消息拟定简短标题。",
              askAgentToRenameSessionsOngoingTitle: "任务变更时",
              askAgentToRenameSessionsOngoingSubtitle: "在会话开始以及任务发生变更时，均提示智能体设置标题。",
              askAgentToRenameSessionsInitialSelectedSubtitle: "智能体会在会话开始时被提示设置标题。",
              askAgentToRenameSessionsOngoingSelectedSubtitle: "智能体会在任务变更时被提示更新标题。",
              askAgentToRenameSessionsDisabledSubtitle: "不提示智能体设置标题；手动重命名仍然有效。",
              askAgentToSuggestReplyOptionsTitle: "请求智能体推荐回复选项",
              askAgentToSuggestReplyOptionsEnabledSubtitle: "提示词将在合适时让智能体提供快捷回复选项。",
              askAgentToSuggestReplyOptionsDisabledSubtitle: "提示词不会要求智能体添加快捷回复选项。",
          },
    defaultPermissions: {
      title: "默认权限",
      footer:
      ...
      applyPermissionChangesNextPromptSubtitle: "仅在下一条消息时应用。",
          ...
          defaultStorage: {
              title: '默认会话类型',
              footer: '选择新会话默认是作为无极开物会话启动，还是作为直接由提供方支持的会话启动。',
              globalTitle: '全局默认',
              persistedSubtitle: '默认将新会话存储在无极开物中，并在设备之间同步。',
  ...
  settingsVoice: {
    ...
    modeTitle: "语音",
    modeDescription:
      "配置语音功能。您可以完全关闭语音、使用无极开物语音（需要订阅），或使用您自己的 ElevenLabs 账号。",
    mode: {
      off: "关闭",
      offSubtitle: "关闭所有语音功能",
      happier: "无极开物语音",
      happierSubtitle: "使用无极开物语音（需要订阅）",
      local: "本地 OSS 语音",
    ...
    byo: {
      ...
      autoprovCreate: "创建无极开物代理",
      autoprovCreateSubtitle:
        "使用您的 API 密钥在 ElevenLabs 账号中创建并配置无极开物代理",
      autoprovUpdate: "更新代理",
      autoprovUpdateSubtitle: "将您的代理更新到最新的无极开物模板",
    ...
    local: {
      ...
      kokoro: {
        ...
        manifest: {
          title: "模型包清单",
          subtitle:
            "默认使用无极开物模型包（可通过 EXPO_PUBLIC_HAPPIER_MODEL_PACK_MANIFESTS 覆盖）。",
          detailResolved: "已解析",
          detailMissing: "缺失",
        },
        assetPack: {
      ...
      conversation: {
        ...
        backend: {
          daemonSubtitle: "使用无极开物后端并支持提供方续接。",
        ...
        resumability: {
          ...
          disabledVoiceAgent: "需要无极开物语音 Agent。",
      ...
      mediatorBackendSubtitle: "Daemon（使用无极开物后端）或 OpenAI 兼容 HTTP",
      ...
      testTtsSample: "你好，这里是无极开物。这是你本地 TTS 的测试。",
    ...
    onboardingShowcase: {
                ...
                "cards": {
                    "welcome": {
                        ...
                        "existingBody": "任何在你机器上运行的 Claude、Codex 或 OpenCode 会话，都可以在无极开物中实时打开。",
                        ...
                        "tuisBody": "在原生终端 UI 中运行 Claude Code、Codex 或 OpenCode。无极开物会捕获它，并同步到每台设备。",
                    ...
                    "mcp": {
                        ...
                        "wideTitle": "一个配置。\n所有 provider。",
                        "body": "在无极开物中定义一次 MCP，它们即可跨所有 backend 工作，甚至包括不原生支持 MCP 的 backend。管理 skills、prompts 等等！",
                        "alt": "共享 MCP 配置的抽象占位图。"
                    },
                    "queue": {
  ...
  terminal: {
    ...
    terminalRequestDescription:
      "有终端正在请求连接到您的无极开物 Coder 账户。这将允许终端安全地发送和接收消息。",
  ...
  modals: {
    ...
    microphoneAccessRequiredRequestPermission:
      "无极开物需要访问你的麦克风用于语音聊天。出现提示时请授予权限。",
    microphoneAccessRequiredEnableInSettings:
      "无极开物需要访问你的麦克风用于语音聊天。请在设备设置中启用麦克风权限。",
  ...
  welcome: {
    ...
    welcomeQuestionBody: "无极开物是你的 AI 编码代理控制中心。无需电子邮件。你的账户是一把在本设备上生成的私钥。",

    welcomePrimaryButton: "第一次使用 — 开始吧",
    welcomePrimarySubtitle: "一次点击。无需表单。你的密钥就在这里。",

    welcomeSecondaryButton: "登录 — 我已在使用无极开物",
    ...
    // "I already use 无极开物" is dropped from the login button title for
    // returning users because — they obviously do already use 无极开物.
    ...
    // custom (non-无极开物-Cloud) relay. The action below the label is the
      ...
      sessionGettingStarted: {
        ...
        manualDisclosure: {
          ...
          subtitle: {
              ...
              connectMachine: ({ targetLabel }: { targetLabel: string }) => `使用桌面端引导流程将此计算机连接到 ${targetLabel}。仅在偏好终端方式时打开手动步骤。`,

              startDaemon: ({ targetLabel }: { targetLabel: string }) => `使用桌面端引导流程为 ${targetLabel} 重新连接后台服务。仅在已位于该计算机上时打开手动步骤。`,
          ...
          steps: {
              ...
              daemonInstall: {
                  ...
                  description: '让无极开物在后台保持就绪，以便远程启动。',
  ...
  setupOnboarding: {
          ...
          preAuthContinueHint: '继续后，无极开物会带你返回到针对所选 Relay 的登录流程，然后再回到这里完成设置。',
    currentRelayTitle: '已选择的 Relay',
    currentRelayDescription: ({ relayUrl }: { relayUrl: string }) => `已选 Relay：${relayUrl}`,
  ...
  review: {
    ...
    installables: {
      screenTitle: "可安装项",
      aboutGroupTitle: "关于",
      aboutSubtitle: "管理无极开物可在此设备上安装并保持最新的工具。",
      ...
      autoUpdatePromptBody: "选择无极开物应如何处理此可安装项的更新。",
      autoUpdateModes: {
        off: "关闭",
        notify: "通知",
        auto: "自动",
  ...
  chatFooter: {
    ...
    directSessionTakeoverAvailable:
      "此直连会话可在你的机器上使用。可在无极开物中接管它并在这里控制。",
    ...
    directTakeoverDialogTitle: "要在无极开物中继续此直连会话吗？",
    directTakeoverDialogBody: "选择无极开物应如何接管。直连将继续使用提供方的会话记录。导入会将记录带入无极开物。",
    directTakeoverDialogDirectTitle: "接管",
    directTakeoverDialogDirectBody: "在无极开物中控制此会话，而不将会话记录导入无极开物。",
    directTakeoverDialogPersistTitle: "接管并导入",
    directTakeoverDialogPersistBody: "将会话记录导入无极开物，并继续使用完整的无极开物会话功能。",
    directTakeoverDialogForceStopTitle: "先尝试停止本地进程",
    directTakeoverDialogForceStopBody: "无极开物找到了此会话对应的可信本地进程。如果你希望无极开物在接管前先停止它，请启用此项。",
    directTakeoverForceStopConfirmTitle: "先停止本地进程？",
    directTakeoverForceStopConfirmBody: "无极开物找到了此直连会话对应的可信本地进程。要在这里接管前先停止它吗？",
  ...
  profiles: {
    ...
    defaultStorage: {
      title: "默认会话类型",
      footer: "当选择此配置文件时，为新会话覆盖账号级默认的无极开物/直连会话类型。",
